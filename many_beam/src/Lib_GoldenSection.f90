    ...
    !*      returns ok = false if timed out
            ...
            if (yt<this%y2) then
               ...
               !   have found a new bound
                ...
                !      y2                    \  /          
                !                             y2               
                !  x1--x2-xt-x3          x1-xt-x2---x3        

               ! print *,"minimise0 new bound x ",this%x1,this%x2,this%x3," y ",this%y1,this%y2,this%y3," x~,y~ ",xt,yt
            ...
            !print *,"minimise0 convergence ",( abs(this%x3 - this%x1) < this%xtol ),abs(this%y2 - max(this%y1,this%y3)),this%y2 ,  max(this%y1,this%y3), ( abs(this%y2 - max(this%y1,this%y3)) < this%ytol )
