...
!	EXTERNAL funcs
	interface   
    	SUBROUTINE funcs(ss,a,ff,dfda,ma)
         	...
         	REAL*8,intent(in)   ::  ss,a(ma)
         	REAL*8,intent(out)  ::  ff,dfda(ma)
	...
	write(6,*) 
     *'INPUT filename (=the output filename for inputTDS.exe)='
...
! 	print *,"TDSfit.f info - input filename """//trim(filename1)//""""
! 	print *,"TDSfit.f info - output filename """//trim(filename2)//""""
	...
	print *,"TDSfit.f info - a ",a(1),a(3),a(5),a(7),a(9)
	print *,"TDSfit.f info - b ",a(2),a(4),a(6),a(8),a(10)
