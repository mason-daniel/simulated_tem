c ******************************************************************************
c 
c                   FORTRAN SOURCE FILE       inputREAL.f
c
c ******************************************************************************** 
c
c                                                        by S. L. Dudarev, 
...
c ******************************************************************************** 
 ...
 1	write(6,*) 
	...
	iflag=0
	do 2 i=1,50
 2	if(elname.eq.elnames(i)) iflag=1
	...
	do 3 j=1,ns
	s=smin + ds*(j-1)
	if(elname.eq.elnames(1)) F=FLI(s)
	if(elname.eq.elnames(2)) F=FBE(s)
	if(elname.eq.elnames(3)) F=FC(s)
	if(elname.eq.elnames(4)) F=FO(s)
	if(elname.eq.elnames(5)) F=FNA(s)
	if(elname.eq.elnames(6)) F=FMG(s)
	if(elname.eq.elnames(7)) F=FAL(s)
	if(elname.eq.elnames(8)) F=FSI(s)
	if(elname.eq.elnames(9)) F=FK(s)
	if(elname.eq.elnames(10)) F=FCA(s)
	if(elname.eq.elnames(11)) F=FTI(s)
	if(elname.eq.elnames(12)) F=FV(s)
	if(elname.eq.elnames(13)) F=FCR(s)
	if(elname.eq.elnames(14)) F=FMN(s)
	if(elname.eq.elnames(15)) F=FFE(s)
	if(elname.eq.elnames(16)) F=FCO(s)
	if(elname.eq.elnames(17)) F=FNI(s)
	if(elname.eq.elnames(18)) F=FCU(s)
	if(elname.eq.elnames(19)) F=FZN(s)
	if(elname.eq.elnames(20)) F=FGA(s)
	if(elname.eq.elnames(21)) F=FGE(s)
	if(elname.eq.elnames(22)) F=FAS(s)
	if(elname.eq.elnames(23)) F=FRB(s)
	if(elname.eq.elnames(24)) F=FSR(s)
	if(elname.eq.elnames(25)) F=FY(s)
	if(elname.eq.elnames(26)) F=FZR(s)
	if(elname.eq.elnames(27)) F=FNB(s)
	if(elname.eq.elnames(28)) F=FMO(s)
	if(elname.eq.elnames(29)) F=FRU(s)
	if(elname.eq.elnames(30)) F=FRH(s)	
	if(elname.eq.elnames(31)) F=FPD(s)
	if(elname.eq.elnames(32)) F=FAG(s)
	if(elname.eq.elnames(33)) F=FCD(s)
	if(elname.eq.elnames(34)) F=FSN(s)
	if(elname.eq.elnames(35)) F=FCS(s)
	if(elname.eq.elnames(36)) F=FBA(s)
	if(elname.eq.elnames(37)) F=FLA(s)
	if(elname.eq.elnames(38)) F=FCE(s)
	if(elname.eq.elnames(39)) F=FGD(s)
	if(elname.eq.elnames(40)) F=FHF(s)	
	if(elname.eq.elnames(41)) F=FTA(s)
	if(elname.eq.elnames(42)) F=FW(s)
	if(elname.eq.elnames(43)) F=FRE(s)
	if(elname.eq.elnames(44)) F=FOS(s)
	if(elname.eq.elnames(45)) F=FIR(s)
	if(elname.eq.elnames(46)) F=FPT(s)
	if(elname.eq.elnames(47)) F=FAU(s)
	if(elname.eq.elnames(48)) F=FTL(s)
	if(elname.eq.elnames(49)) F=FPB(s)
	if(elname.eq.elnames(50)) F=FTH(s)	
